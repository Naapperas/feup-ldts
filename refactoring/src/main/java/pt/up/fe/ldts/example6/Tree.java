...
public class Tree {
    ...
    public boolean isNextAppraisalOverdue(){
        ...
        Date latestAppraisalDate = this.getLatestApraisalDate(today);

        Date nextAppraisalDate = this.getNextApraisalDate(latestAppraisalDate);
        // Appraisal is only overdue if its date is in the past
        return nextAppraisalDate.before(today);
    }

    private Date getLatestApraisalDate(Date today) {
    ...
    private Date getNextApraisalDate(Date latestAppraisalDate) {
